    ...
    <div className="space-y-6">
      <div className="bg-[#1E1E1E] rounded-xl p-6 shadow-lg hover:shadow-[0_0_15px_rgba(79,142,247,0.2)] transition-all duration-300">
        ...
        <div className="grid grid-cols-2 gap-4 text-gray-400">
          <div>
            <div className="mb-4">Full Name: <span className="text-white">&lt;name&gt;</span></div>
            <div>Insurance: <span className="text-white">&lt;insurance&gt;</span></div>
          </div>
          <div>
            <div className="mb-4">Email: <span className="text-white">&lt;email&gt;</span></div>
  ...
  const renderDoctorDashboard = () => (
    <div className="space-y-6">
      <div className="bg-[#1E1E1E] rounded-xl p-6 shadow-lg hover:shadow-[0_0_15px_rgba(79,142,247,0.2)] transition-all duration-300">
        ...
        <div className="grid grid-cols-2 gap-4 text-gray-400">
          <div>
            <div className="mb-4">Name: <span className="text-white">&lt;name&gt;</span></div>
            <div className="mb-4">Specialty: <span className="text-white">&lt;specialty&gt;</span></div>
            <div>Hospitals: <span className="text-white">&lt;hospitals&gt;</span></div>
          </div>
          <div>
            <div className="mb-4">Email: <span className="text-white">&lt;email&gt;</span></div>
          </div>
        ...
        <div className="grid grid-cols-5 gap-4">
          {[1, 2, 3, 4, 5, 6, 7].map((_, index) => (
            <div key={index} className="bg-[#2A2A2A] rounded-lg p-4 text-gray-400">
              <div className="mb-4">Patient: <span className="text-white">&lt;patient&gt;</span></div>
              <div className="mb-4">Hospital: <span className="text-white">&lt;hospital&gt;</span></div>
              <div className="mb-4">Reason: <span className="text-white">&lt;reason&gt;</span></div>
              <div>Date & Time: <span className="text-white">&lt;datetime&gt;</span></div>
            </div>
          ))}
        </div>
      </div>
    ...
    <div className="min-h-screen bg-[#121212]">
      <nav className="bg-[#1E1E1E] border-b border-[#2A2A2A] px-4 py-2.5">
        <div className="container mx-auto flex items-center justify-between">
          ...
          <span className="text-gray-300 text-lg">Dashboard - {user?.name || 'User'}</span>
          <button
